...
enum
{
	...
	HEADER_GD_MYSHOP_PRICELIST_UPDATE	= 108,		///< ����d�� ���� ��û
	HEADER_GD_MYSHOP_PRICELIST_REQ		= 109,		///< ����d�� ����Ʈ ��û

	HEADER_GD_BLOCK_CHAT				= 110,

	HEADER_GD_RELOAD_ADMIN			= 115,			///<��� d�� ��û
	...
	HEADER_DG_MYSHOP_PRICELIST_RES	= 157,		///< ����d�� ����Ʈ �4�
	HEADER_DG_RELOAD_ADMIN = 158, 				///< ��� d�� ���ε� 
...
typedef struct SPlayerItem
{
	...
	DWORD	vnum;
	TimeT64	alSockets[ITEM_SOCKET_MAX_NUM];	// ���Ϲ�ȣ
...
typedef struct SShopItemTable
{
    ...
    TItemPos	pos;			// PC ��a���� �̿�
	GoldType price;	// PC, shop_table_ex.txt ��a���� �̿�
	BYTE		display_pos; // PC, shop_table_ex.txt ��a���� �̿�, ���� 'ġ.
} TShopItemTable;
...
typedef struct SItemTable : public SEntityTable
{
	...
	// �Ʒ� limit flag��: realtime�� üũ �� ���� ����, ������ VNUM�� ��d�� ���ε�,
	// ���� ��v��� �Ź� �����۸��� �ʿ��� ��쿡 LIMIT_MAX_NUM���� ���u��鼭 üũ�ϴ� ���ϰ� Ŀ�� �̸� ���� �� ��.
	char		cLimitRealTimeFirstUseIndex;		// ������ limit �ʵ尪 �߿��� LIMIT_REAL_TIME_FIRST_USE �÷����� 'ġ (��8�� -1)
	char		cLimitTimerBasedOnWearIndex;		// ������ limit �ʵ尪 �߿��� LIMIT_TIMER_BASED_ON_WEAR �÷����� 'ġ (��8�� -1) 
...
typedef struct SPacketGDSetup
{
	...
	BYTE	bChannel;	// ä��
	WORD	wListenPort;	// Ŭ���̾�Ʈ�� b���ϴ� ��Ʈ ��ȣ
...
/// ���λ�a ����d���� ���. ���� ��Ŷ8�� �� �ڿ� byCount ��ŭ�� TItemPriceInfo �� �´�.
typedef struct SPacketMyshopPricelistHeader
{ 
	DWORD	dwOwnerID;	///< ����d���� ���� �÷��̾� ID 
	BYTE	byCount;	///< ����d�� ����
...
typedef struct SItemPriceListTable
{
	...
	TItemPriceInfo	aPriceInfo[SHOP_PRICELIST_MAX_NUM];	///< ����d�� ����Ʈ
} TItemPriceListTable;
...
{
	int m_ID;				//��/ID
	char m_szAccount[32];	//��d
	char m_szName[32];		//ĳ�����̸�
	char m_szContactIP[16];	//b�پ�����
