...
enum ECostumeSubTypes
{
	...
	COSTUME_HAIR = ARMOR_HEAD,			// �̴� �ڽ��� �����ۿ� �߰� �Ӽ�; ���̰ڴٴ� ������ ��û�� ���� ��x ����; Ȱ���ϱ� '����.
	COSTUME_NUM_TYPES,
};
...
enum EItemAntiFlag
{
	...
	ITEM_ANTIFLAG_EMPIRE_A	= (1 << 9), // A f�� ��� �Ұ�
	ITEM_ANTIFLAG_EMPIRE_B	= (1 << 10), // B f�� ��� �Ұ�
	ITEM_ANTIFLAG_EMPIRE_C	= (1 << 11), // C f�� ��� �Ұ�
	ITEM_ANTIFLAG_SAVE		= (1 << 12), // ������� ��=
	ITEM_ANTIFLAG_GIVE		= (1 << 13), // �ŷ� �Ұ�
	ITEM_ANTIFLAG_PKDROP	= (1 << 14), // PK�� �������� ��=
	ITEM_ANTIFLAG_STACK		= (1 << 15), // ��ĥ �� ��=
	ITEM_ANTIFLAG_MYSHOP	= (1 << 16), // ���� ��a�� �ø� �� ��=
...
enum ELimitTypes
{
	...
	/// ���� ���ο� ��� ���� �ǽð�8�� �ð� �� (socket0�� �Ҹ� �ð��� ����: unix_timestamp Ÿ��)
	LIMIT_REAL_TIME,						

	/// ������; �� ó= ���(Ȥ: ����) �� �������� ����Ÿ�� Ÿ�̸� ���� 
	/// ���� ��� ������ socket0�� ��밡�ɽð�(�ʴ�', 0�̸� �w����� limit value�� ���) ���� �����ִٰ� 
	/// ������ ���� socket1�� ��� Ƚ�� ����� socket0�� unix_timestamp Ÿ���� �Ҹ�ð��� ����.
	LIMIT_REAL_TIME_START_FIRST_USE,

	/// ������; ���� ���� ���� ��� �ð��� ��Ǵ� ������
	/// socket0�� ��: �ð��� �ʴ�'�� ����. (������ ���� ���� �ش� ���� 0�̸� �w����� limit value��; socket0�� ����)
