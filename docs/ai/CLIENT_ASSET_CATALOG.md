...
|---|---|---|
| assets/client/ui/ | Lead-Client/pack/ETC/ymir work/ui | Allgemeine UI-Atlanten, Intro/Login/Select, Taskbar und Ingame-Fenster. |
...
| assets/client/icons/item/ | Lead-Client/pack/icon/icon/item | Direkt referenzierte Item-TGA-Icons. |
| assets/client/icons/action/ | Lead-Client/pack/icon/icon/action | Emotes/Aktions-Icons. |
...
## Umfang dieses Snapshots

- Allgemeine UI: 1.027 Dateien.
- Deutsche UI-Assets: 202 Dateien.
- Item-Icons: 1.552 Dateien.
- Aktions-/Gesichts-Icons: 25 Dateien.
- Loading: 49 Dateien.
- UI-Skripte: 70 Dateien.
- Character-Select-Effekte: 5 Dateien.

Der übrige Pack bleibt bewusst lokal, insbesondere Welt-, Monster-, Map-, Sound- und vollständige Servermaterialien.